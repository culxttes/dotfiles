    ...
    menus: {
        dashboard: {
            powermenu: {
                ...
                avatar: {
                    image: opt("/home/culottes/.config/logo.png"),
            ...
            shortcuts: {
                left: {
                    ...
                    shortcut4: {
                        ...
                        command: opt("rofi -show drun -theme $HOME/.config/rofi/launchers/type-6/style-6.rasi")
                    },
                },
                right: {
                    shortcut1: {
